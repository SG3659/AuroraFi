...
- Total Expenses: $INR{totalExpenses.toFixed(2)}
- Available Balance: $INR{availableBalance.toFixed(2)}
...
✅ Example:
[
   "Nice! You kept INR 7,458 after expenses — that’s solid breathing room.",
