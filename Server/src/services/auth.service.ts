import type { registerSchemaType, loginSchemaType, updatePasswordType, oauthSchemaType } from "../validators/auth.validator.js"
...
export const oauthLoginService = async (body: oauthSchemaType) => {
   ...
   try {
      ...
      const {
         accessToken,
         tokenExpiresAt } = accessJwtToken(newUser.id);
      return {
